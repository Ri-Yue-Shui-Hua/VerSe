...
def ct_resample(img, voxel_spacing=(1, 1, 1), order=3, is_label=False):
    ...
    new_img = nip.resample_from_to(img, (new_shp, new_aff), order=order, mode=mode, cval=cval)
